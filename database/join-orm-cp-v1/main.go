...
func (t Teacher) Join(db *gorm.DB) ([]Joined, error) {
	// menampilkan data teacher_name (dari kolom name pada table teachers),
	// school_name (dari kolom name pada table schools),
	// class_name (dari kolom name pada table classes)
	// dan lesson_name (dari kolom name pada table lessons) dalam bentuk struct Joined.
